...
class MyFrameQ7 extends JFrame implements ActionListener{
	...
	private JButton b2=new JButton("Add Even");private JTextField t3=new JTextField("0",15);
	private JPanel p1=new JPanel();
	ArrayList<Integer> list = new ArrayList<Integer>();

	public     static int addEven(ArrayList list){              // to be completed
		...
		if (list.size()==0) return 0;
	 		  ...
	 		  list.remove(0);
	 		   if(first%2==0)  return first + addEven(list);
	 		   else  return 0 + addEven(list);
	 	   }
 	   
 	   }

	
	public MyFrameQ7(String s){
		super(s);
	...
	public void actionPerformed(ActionEvent e){
 	...
 	if (target==b2){ 
  		int res = addEven(new ArrayList(list));
  		t3.setText(""+res);
     	}
     }
	 }
