...
class MyFrameQ9 extends JFrame implements ActionListener{
	...
	public static int max(ArrayList list){              // to be completed
	...
	public void actionPerformed(ActionEvent e){
 	...
 	if (target==b2){ 
  		int res = max(new ArrayList(list));
  		t3.setText(""+res);
     	}
     }
	 }
