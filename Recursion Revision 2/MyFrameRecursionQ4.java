...
class MyFrameRecursionQ4 extends JFrame implements ActionListener{
	...
	private JButton b1=new JButton("  searchTarget");private JTextField t2=new JTextField("0",15);
	private JButton b2=new JButton("allOdd");private JTextField t3=new JTextField("0",15);
